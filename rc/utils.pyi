...
Attribute = NamedTuple('Attribute', defining=type, es=Es, field=Es, hint=Any, kind=Kind, name=str,
                        object=Any, qual=str)
InfoClsBase = NamedTuple('InfoClsBase', attribute=dict[str, Attribute], builtin=Optional[Type], cls=Optional[Type],
                         es=Es, hint=dict[str, Any], importable=str, modname=str, mro=Optional[tuple[Type, ...]],
                         name=Optional[str],
                         qual=Optional[str], super=Optional[Type])
