...
class Get(GetBase):
    ...
    @classmethod
    @functools.cache
    def getenum_members(cls) -> GetEnumMembers: ...
    @classmethod
    @functools.cache
    def getenum_pickle_classes(cls) -> TupleType: ...
    @classmethod
    @functools.cache
    def getenum_pickle_members_by_class(cls) -> dict[Type, Get]: ...
    @property
    @functools.cache
    ...
    @property
    @functools.cache
    def is_value_tuple(self) -> bool: ...
    def mro_first_attr_value_in_obj(self, obj: Any) -> Any: ...
    @classmethod
    def slots_include(cls, obj: Any) -> TupleStr: ...
    def val(self, obj: Any) -> TupleStr: ...
    @property
    @functools.cache
    def value_class(self) -> Type: ...
    @property
    @functools.cache
    def value_default(self) -> TupleStr: ...
    @property
    @functools.cache
...
class Name(NameBase):
    ...
    @classmethod
    @functools.cache
    def private(cls) -> TupleStr: ...
    @classmethod
    @functools.cache
    def public(cls) -> TupleStr: ...
    @classmethod
    @functools.cache
...
class PrivateBase(EnumBase):
    ...
    def getter(self) -> attrgetter: ...
    def has(self, obj: Any) -> bool: ...
    def in_slot(self, obj: Any, name: str) -> bool: ...
...
GetEnumMembers = NamedTuple('GetEnumMembers', all=dict[str, Get], pickle=dict[str, Get], private=dict[str, Get],
                        protected=dict[str, Get], public=dict[str, Get])
EnumBaseAlias: Alias
...
class Es(Generic[_T]):
    ...
    @functools.cache
    def has(self, name: AttrUnion) -> Bool: ...
    @property
    @functools.cache
    ...
    @functools.cache
    def readonly(self, name: AttrUnion = ...) -> Union[Bool, Exception]: ...
    @property
    @functools.cache
    ...
    def slist(self) -> Bool: ...
    @functools.cache
    def slot(self, name: AttrUnion) -> Bool: ...
    @property
    @functools.cache
    ...
    @functools.cache
    def writeable(self, name: AttrUnion) -> Bool: ...
    # </editor-fold>
    ...
    @functools.cache
    def mro_first_data(self, name: AttrUnion) -> Union[Any, NotImplemented]: ...
    @functools.cache
    def mro_first_dict(self, name: AttrUnion, mro: Tuple[Type[Any, DataType], ...]) -> Union[Any, NotImplemented]: ...
    @functools.cache
    def mro_first_dict_no_object(self, name: AttrUnion) -> Union[Any, NotImplemented]: ...
    @functools.cache
    def mro_values(self, name: AttrUnion) -> TupleStr: ...
    @functools.cache
    def mro_values_default(self, name: AttrUnion) -> Tuple[Union[str, Type[Any]], ...]: ...
    @property
    @functools.cache
    ...
    @functools.cache
    def slots_include(self, name: AttrUnion) -> TupleStr: ...
    @property
    @functools.cache
    def super(self) -> Type: ...
    # </editor-fold>
