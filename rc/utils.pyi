...
Attribute = NamedTuple('Attribute', annotation=Annotation, default=Union[Any, NotImplemented], defining=type, es=Es,
                       field=Es, kind=Kind, name=str, object=Any, qual=str)
...
class Seq(Sequence[_ST_co]):
    __builtin: Type[GetItemSupportType] = ...
    __slots__: tuple[str, ...] = ...
    @abstractmethod
    ...
    def all_allin(self, *args: Any, **kwargs: _VT) -> Union[Seq[_ST_co], slist[Any, ...], stuple[Any, ...]]: ...
    def all_anyin(self, *args: Any, **kwargs: _VT) -> Union[Seq[_ST_co], slist[Any, ...], stuple[Any, ...]]: ...
    def first_allin(self, *args: Any, **kwargs: _VT) -> Any: ...
    def first_anyin(self, *args: Any, **kwargs: _VT) -> Any: ...
    def get_allin_dict(self, *args: Any, **kwargs: _VT) -> Union[Seq[_ST_co], slist[Any, ...], stuple[Any, ...]]: ...
    def get_anyin_dict(self, *args: Any, **kwargs: _VT) -> Union[Seq[_ST_co], slist[Any, ...], stuple[Any, ...]]: ...
    def get_attr(self, *args: str) -> Union[Seq[_ST_co], slist[Any, ...], stuple[Any, ...]]: ...
class slist(list, Seq[_SLT]):
    ...
    def __repr__(self) -> str: ...
class stuple(tuple, Seq[_STT]):
    __slots__: tuple[str, ...] = ...
    def __new__(cls, iterable: Iterable[_STT_co] = ...) -> stuple: ...
    def __init__(self, iterable: Iterable[_STT_co]) -> None: ...
    def __repr__(self) -> str: ...
# </editor-fold>
