...
__all__: tuple
BUILTINS: dict
BUILTINS_CLASSES: Iterable[Type]
...
@singledispatch
def asdict(data: Union[Semaphore, Enum, Chain, Environs, GitSymbolicReference, IgnoreStrType,
...
def asdict_ignorestr(data: IgnoreStrType, convert: bool = ...) -> Union[str, IgnoreStrType]: ...
