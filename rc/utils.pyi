...
Seq = Union[AnyStr, ByteString, Iterator, KeysView, MutableSequence, MutableSet, Sequence, tuple, ValuesView]
...
class Es:
    ...
    def _data(self) -> Any: ...
    @property
    def _fget(self) -> Optional[Callable]: ...
    @property
    def _func(self) -> Optional[Callable]: ...
    @property
    ...
    @property
    def asyncgeneratortype(self) -> Bool: ...
    @property
...
class GetType(Protocol):
    def get(self, name: str, default: Any = ...) -> Any:
        pass
IsCoro = NamedTuple('IsCoro', asyncfor=bool, asyncfunctiondef=bool, asyncgen=bool, asyncgeneratortype=bool,
                    asyncgenfunc=bool, asyncwith=bool, awaitable=bool, coro=bool, coroutine=bool, coroutinefunc=bool,
                    coroutinetype=bool)
class Kind(Enum, Generic[_K]):
    ...
    PROPERTY: _K
    STATIC: _K
Attribute = NamedTuple('Attribute', coro=bool, defining=type, es=Es, field=Field, hint=Any, kind=Kind, name=str,
                       object=Any)
class _Mro(Enum):
